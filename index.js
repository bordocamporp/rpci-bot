      ...
      if (interaction.customId.startsWith('competition_modal_')) {
        ...
        await interaction.reply({
          content:
            ...
            'Il messaggio con il logo verrà cancellato automaticamente. Hai 2 minuti di tempo.',
          flags: MessageFlags.Ephemeral
        });
        ...
        try {
          ...
          if (!isImage) {
            ...
            return interaction.followUp({
              content: '❌ Il logo deve essere un’immagine. Ricomincia con `/crea_competizione`.',
              flags: MessageFlags.Ephemeral
            });
          }
          ...
          draft.clubs = clubs;
          draft.existingLeagueCompetitions = type === 'league'
            ? await getExistingLeagueCompetitionsForLink(name)
            : [];
          ...
          competitionDrafts.delete(interaction.user.id);
          return interaction.followUp({
            content: '❌ Tempo scaduto per caricare il logo. Ricomincia con `/crea_competizione`.',
            flags: MessageFlags.Ephemeral
          });
        }
      }
