...
if (interaction.customId === 'player_search_create') {
        ...
        const consoleId = new TextInputBuilder()
          ...
          .setLabel('ID CONSOLE')
          .setPlaceholder('Inserisci il tuo ID console')
          .setStyle(TextInputStyle.Short)
          .setRequired(true);

        const experiences = new TextInputBuilder()
          .setCustomId('experiences')
          .setLabel('ESPERIENZE')
          .setPlaceholder('Club precedenti e competizioni disputate')
          .setStyle(TextInputStyle.Paragraph)
          .setRequired(true);
        ...
        modal.addComponents(
          ...
          new ActionRowBuilder().addComponents(experiences)
        );
...
if (interaction.customId === 'player_search_modal') {
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields(
            ...
            { name: '🆔 ID Console', value: consoleId.slice(0, 1024), inline: true },
            { name: '📝 Esperienze', value: experiences.slice(0, 1024), inline: false }
          )
          .setFooter({ text: 'RPCI • Player cerca squadra' })
          .setTimestamp();
